...
module.exports = function (log) {
   ...
   */
  module.addContracts = function (values, callback) {
    var request = new mssql.Request(pool)
   ...
   */
  module.getContractName = function (contractHash, callback) {
    var request = new mssql.Request(pool)
   ...
   */
  module.addDataPoints = function (values, callback) {
    var request = new mssql.Request(pool)
    var valueString = buildValueString(values)
    var sql =
  ...
  module.updateFromTo = function (contractHash, method, from, to, callback) {
    var request = new mssql.Request(pool)
  ...
  module.addVariable = function (values, callback) {
    var request = new mssql.Request(pool)
    var valueString = buildValueString(values)
   ...
   */
  module.getDataPoints = function (contractHash, method) {
    return new Promise(function (resolve, reject) {
      var request = new mssql.Request(pool)
      var sql =
  ...
  module.getVariables = function (contractHash) {
    return new Promise(function (resolve, reject) {
      var request = new mssql.Request(pool)
  ...
  module.getBlockTime = function (blockNumber) {
    return new Promise(function (resolve, reject) {
      var request = new mssql.Request(pool)
  ...
  module.addBlockTime = function (values, callback) {
    var request = new mssql.Request(pool)
    var valueString = buildValueString(values)
   ...
   * for a given contract hash
   */
  module.getDataPointsInDateRange = function (contractHash, method, from, to) {
    return new Promise(function (resolve, reject) {
      var request = new mssql.Request(pool)
      var sql =
        'select timeStamp, value from (DataPoints inner join Blocks on DataPoints.blockNumber = Blocks.blockNumber) ' +
  ...
  module.updateCachedUpToBlock = function (contractHash, method, value) {
    return new Promise(function (resolve, reject) {
      var request = new mssql.Request(pool)
  ...
  module.getCachedFromTo = function (contractHash, method) {
    return new Promise(function (resolve, reject) {
      var request = new mssql.Request(pool)
  ...
  module.getLatestCachedBlockTime = function (callback) {
    var request = new mssql.Request(pool)
