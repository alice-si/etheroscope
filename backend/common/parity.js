...
module.exports = function (db, log) {
    ...
    parity.getContractVariables = async function (contractInfo) {
        ...
        let variableNames = []
        variables.forEach(variable => {variableNames.push(variable.name)});
